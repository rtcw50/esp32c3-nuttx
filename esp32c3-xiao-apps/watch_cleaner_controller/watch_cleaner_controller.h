...
#define MSG_ACTION_PWM_SET_DUTY 2
#define MSG_ACTION_PWM_REVERSE 3
#define MSG_ACTION_PWM_ABORT 4
#define MSG_ACTION_PWM_SET_DUTY_ALL 5
...
#define TIME_FORMAT "%02" PRId32 ":%02" PRId32
#define SCALAR_FORMAT "%4" PRId32

/* Nominal clean and rinse */
...
/*  Easy clean and rinse */
#define CLEAN_DUR_DEFAULT2 (60)
#define RINSE_DUR_DEFAULT2 (60)
#define SPIN_DUR_DEFAULT2 (1*30)
#define AGITATE_DUR_DEFAULT2 (8)
#define RPM_DEFAULT2 (200)
#define RAMP_FACTOR_DEFAULT2 (1)

/* Aggressive clean and rinse */
#define CLEAN_DUR_DEFAULT3 (10*60)
#define RINSE_DUR_DEFAULT3 (5*60)
#define SPIN_DUR_DEFAULT3 (2*60)
#define AGITATE_DUR_DEFAULT3 (4)
#define RPM_DEFAULT3 (400)
#define RAMP_FACTOR_DEFAULT3 (5)
...
#define RAMP_UPDATE_STEPS_PER_SECOND (4)

#define WCC_IN1 5
#define WCC_IN2 21

#define WCC_PRESET_COUNT 3
...
struct timespec wcc_get_min_deadline(struct timespec *t1,
                                     struct timespec *t2,
                                     struct timespec *t3);
...
void wcc_calibration_setup(void);
